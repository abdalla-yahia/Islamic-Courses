...
<footer style={{background:'#5b3f11 url("/images/header.png")'}} className="text-white rounded-lg shadow bg-[#5b3f11] mt-4">
    <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        ...
        <span className="block text-sm text-gray-200 sm:text-center">جميع الحقوق محفوظة  ©  {new Date().getFullYear()} <Link href="mailto:abdalla_y2007@yahoo.com/" className="hover:underline text-orange-600 font-bold text-lg">موقع فضيلة الشيخ خالد منصور™ </Link> </span>
    </div>
</footer>
