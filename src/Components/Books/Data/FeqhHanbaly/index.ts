...
// import Omdat_Al_Ahkam from './Omdat_Al_Ahkam.json';
// import Taysesr_Al_Alalam from './Tayseer_Al_Alam.json';
// import Zad_ElMostaqneaa from './Zad_Elmostaqneaa.json';
// import Zad_AlMostaqneaa_Shankety from './Zad_Al_Mostaknea_Shankety.json';
...
// import Bdayet_Al_Mogtahed from './Bdayet_Al_Mogtahed.json';
// import Montaha_Al_Eradat from './Montaha_Al_Eradat.json'
...
export default function Feqh_Hanbalyan(){
    return {
        ...
        books:[
            ...
            // Blogh_Almaram,
            // Zad_ElMostaqneaa,
            // Zad_AlMostaqneaa_Shankety,
            // Zad_AlMostaqneaa_Shoaeear,
            // Mokhtasr_ElKheraky,
            // AlKafy_Waeaaly,
            // AlKafy,
            // Bdayet_Al_Mogtahed,
