...
export default function SahabaBage() {
  ...
  return (
    ...
    <input onChange={(e)=>SetSearch(e.target.value)} type="search" name="" id="" className='w-full lg:w-[80%] rounded outline-none border-none my-2 p-1 text-gray-900' placeholder='بحث عن صحابي ...'/>
    </div>
